...
v0.1.1 - Arch release (additional release are in planning)

For this early build of ZyherOS I am at the stage where its a bootstrap script.  The process for installing zypherOS v0.1.1 is below:

* ZypherOS Alpha v0.1.1 has been released.  The ISO installer can be found at the link below:


* https://github.com/zypher-systems/Zypher_OS/releases/tag/v0.1.1-alpha
